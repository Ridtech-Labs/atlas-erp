...
class Container_4a09cf6b29 extends _PHPStan_02959ca10\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0460(): PHPStan\Reflection\ClassReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\ClassReflectionFactory {
			...
			public function __construct(Container_4a09cf6b29 $container)
			{
	...
	public function createServiceContainer(): Container_4a09cf6b29
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'NVM_CD_FLAGS' => '-q',
				'COMPOSER_BINARY' => '/Users/ridwankadri/Library/Application Support/Herd/bin/composer',
				'TERM' => 'dumb',
				'SHELL' => '/bin/zsh',
