...
class Container_802593584c extends _PHPStan_02959ca10\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0460(): PHPStan\Reflection\ClassReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\ClassReflectionFactory {
			...
			public function __construct(Container_802593584c $container)
			{
	...
	public function createServiceContainer(): Container_802593584c
	{
		return $this;
	}
