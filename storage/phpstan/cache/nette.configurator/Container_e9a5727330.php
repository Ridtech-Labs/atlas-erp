...
class Container_e9a5727330 extends _PHPStan_02959ca10\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0460(): PHPStan\Reflection\ClassReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\ClassReflectionFactory {
			...
			public function __construct(Container_e9a5727330 $container)
			{
	...
	public function createServiceContainer(): Container_e9a5727330
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'paths' => [
				...
				'/Users/ridwankadri/Desktop/code/atlas-erp/database',
