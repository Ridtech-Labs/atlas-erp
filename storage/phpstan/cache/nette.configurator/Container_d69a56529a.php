...
class Container_d69a56529a extends _PHPStan_02959ca10\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0460(): PHPStan\Reflection\ClassReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\ClassReflectionFactory {
			...
			public function __construct(Container_d69a56529a $container)
			{
	...
	public function createServiceContainer(): Container_d69a56529a
	{
		return $this;
	}
