...
class Container_8038e80d71 extends _PHPStan_02959ca10\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0460(): PHPStan\Reflection\ClassReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\ClassReflectionFactory {
			...
			public function __construct(Container_8038e80d71 $container)
			{
	...
	public function createServiceContainer(): Container_8038e80d71
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'REDIS_PASSWORD' => 'null',
				'_' => '/Users/ridwankadri/Library/Application Support/Herd/bin/php83',
				...
				'CODEX_CI' => '1',
				'APP_DEBUG' => 'true',
				'APP_KEY' => 'base64:09LfokOvTQb62ATcKo1SyOfAuNqolU1TcKusx7DfWIc=',
				'LINES' => '50',
