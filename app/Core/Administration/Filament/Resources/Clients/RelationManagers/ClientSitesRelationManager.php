        ...
        return $schema->components([
            Section::make('Site profile')
                ->schema([
                    ...
                    Textarea::make('address')->required()->rows(3)->placeholder('Full address for dispatching and site visits.'),
                    ...
                    Textarea::make('access_instructions')->rows(3)->placeholder('Access control notes, gate contacts, or safety requirements.'),
                    Textarea::make('operational_notes')->rows(3)->placeholder('Service windows, equipment constraints, or delivery notes.'),
